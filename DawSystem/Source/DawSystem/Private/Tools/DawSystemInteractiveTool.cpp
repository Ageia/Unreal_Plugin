...
#include "DawSystemInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UDawSystemInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UDawSystemInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UDawSystemInteractiveTool* NewTool = NewObject<UDawSystemInteractiveTool>(SceneState.ToolManager);
...
UDawSystemInteractiveToolProperties::UDawSystemInteractiveToolProperties()
{
...
void UDawSystemInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UDawSystemInteractiveTool::Setup()
{
	...
	Properties = NewObject<UDawSystemInteractiveToolProperties>(this, "Measurement");
...
void UDawSystemInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UDawSystemInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UDawSystemInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UDawSystemInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UDawSystemInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UDawSystemInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UDawSystemInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UDawSystemInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UDawSystemInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
