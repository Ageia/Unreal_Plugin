...
#include "DawSystemInteractiveTool.generated.h"


/**
 * Builder for UDawSystemInteractiveTool
 */
UCLASS()
class DAWSYSTEM_API UDawSystemInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UDawSystemInteractiveTool
 */
UCLASS(Transient)
class DAWSYSTEM_API UDawSystemInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UDawSystemInteractiveToolProperties();
...
/**
 * UDawSystemInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class DAWSYSTEM_API UDawSystemInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UDawSystemInteractiveToolProperties> Properties;
