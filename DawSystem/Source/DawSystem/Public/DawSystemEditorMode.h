...
#include "DawSystemEditorMode.generated.h"
 ...
 */
UCLASS()
class UDawSystemEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_DawSystemEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UDawSystemEditorMode();
	virtual ~UDawSystemEditorMode();
